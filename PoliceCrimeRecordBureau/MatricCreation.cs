...
/// <summary>
/// Summary description for MatricCreation
/// </summary>
/// 
namespace PoliceCrimeRecordBureau
{
    public class MatricCreation
    {
        ...
        public double[][] MatrixRandom(int rows, int cols, double minVal, double maxVal, int seed)
        {
        ...
        //public void lateruse()
        //{
        //    ds.Clear();
        //    ds = db.discont("truncate table vtemp");

        //    int count = int.Parse(db.extscalr("select max(keyword_count) from vector_set"));
        ...
        //        ds.Clear();
        //        ds = db.discont("select * from vector_set where keyword_count='" + i + "'");

        //        for (int j = 0; j < ds.Tables[0].Rows.Count; j++)
        //        {
        //            matrixs = matrixs + ds.Tables[0].Rows[j]["matrix_value"].ToString() + ",";
        //            invrses = invrses + ds.Tables[0].Rows[j]["inverse_matrix"].ToString() + ",";
        //            string kks = ds.Tables[0].Rows[0]["v_key"].ToString();
        //            string setn = ds.Tables[0].Rows[0]["set_name"].ToString();
        //            Session["kk"] = kks;
        //            Session["setn"] = setn;
        //        }

        //        bool b = db.extnon("insert into vtemp values('" + Session["setn"] + "','" + i + "','" + matrixs + "','" + invrses + "','" + Session["kk"] + "')");
        //    }
        //    ds.Clear();
